...
public class NodeControllerTest extends AbstractContextControllerTests {
	...
	public void setUpClass() {
		...
		ds.setUrl("jdbc:postgresql://192.168.0.5:5432/opennms");
	...
	public void nodeIdIpinterfaces() throws Exception {
		mockMvc.perform(
				get("/nodes/" + id + "/ipinterfaces").accept(
	...
	public void nodeIdIpinterfacesIpAddress() throws Exception {
		mockMvc.perform(
				get("/nodes/" + id + "/ipinterfaces/" + ipAddress).accept(
						MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
	...
	public void nodeIdIpinterfacesService() throws Exception {
		mockMvc.perform(
				get("/nodes/" + id + "/ipinterfaces/" + ipAddress + "/services")
	...
	public void nodeSnmpinterfaces() throws Exception {
		mockMvc.perform(
				get("/nodes/" + id + "/snmpinterfaces").accept(
						MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
				.andExpect(content().string(containsString("@totalCount")));
	}
	...
	public void nodeSnmpinterfacesIfIndex() throws Exception {
		mockMvc.perform(
				get("/nodes/" + id + "/snmpinterfaces/" + ifIndex).accept(
						MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
	...
	public void nodeCategories() throws Exception {
		mockMvc.perform(
				get("/nodes/" + id + "/categories").accept(
						MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
	...
	public void nodeCategoriesCategoryName() throws Exception {
		mockMvc.perform(
				get("/nodes/" + id + "/categories/" + categoryName).accept(
						MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
	...
	public void nodeAssetRecord() throws Exception {
		mockMvc.perform(
				get("/nodes/" + id + "/assetRecord").accept(
						MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
				.andExpect(content().string(containsString("category")));
	}
	...
	public void serviceList() throws Exception {
		mockMvc.perform(get("/serviceList")).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
	...
	public void nodeSearchService() throws Exception {
		mockMvc.perform(
				get("/nodes/searchService/" + serviceId).accept(
						MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
	...
	public void nodeSearchIp() throws Exception {
		mockMvc.perform(
				get("/nodes/searchIp/" + iplike).accept(
						MediaType.APPLICATION_JSON)).andExpect(status().isOk())
		// .andExpect(content().contentType("application/json;charset=UTF-8"))
				.andExpect(content().string(containsString("@totalCount")));
	}
	...
	public void nodesIpInterfacesServicesPut() throws Exception {
		...
		mockMvc.perform(
				put("/nodes/" + id + "/ipinterfaces/" + ipAddress
						+ "/services/" + serviceName + "?status=R")).andExpect(
				status().isOk());
	...
	public void nodesIpinterfacesPut() throws Exception {
		...
		mockMvc.perform(
				put("/nodes/" + id + "/ipinterfaces/" + ipAddress
						+ "?isManaged=M")).andExpect(status().isOk());
	...
	public void nodesSnmpinterfacesPut() throws Exception {
		...
		mockMvc.perform(
				put("/nodes/" + id + "/snmpinterfaces/" + ifIndex
						+ "?collect=UN")).andExpect(status().isOk());
	...
	public void nodesPut() throws Exception {
		...
		mockMvc.perform(put("/nodes/" + id + "?label=test")).andExpect(
				status().isOk());
