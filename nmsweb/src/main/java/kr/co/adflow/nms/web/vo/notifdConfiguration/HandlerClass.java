 ...
 *         &lt;element ref="{http://xmlns.opennms.org/xsd/config/notifd}init-params" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class HandlerClass {
    ...
    protected List<InitParams> initParams;
    ...
    public List<InitParams> getInitParams() {
        if (initParams == null) {
            initParams = new ArrayList<InitParams>();
        }
